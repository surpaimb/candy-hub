  ...
  <body>
    <div class="wrap" id="app">
      <div class="sidebar">
        ...
        <nav class="side-nav">
          <ul>
              <li @if(request()->segment(2) == 'dashboard') class="active" @endif><a href="{{ route('hub.index') }}" >{{trans('titles.dashboard')}}</a></li>
              <li><a href="{{ route('logout') }}">{{trans('titles.logout')}}</a></li>
          </ul>
        </nav>
