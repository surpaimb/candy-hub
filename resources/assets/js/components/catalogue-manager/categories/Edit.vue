    ...
    loadCategory(id) {
      apiRequest
        .send(
          ...
          {
            includes:
              'channels,layout,assets,assets.tags,children,parent,attribute_groups,attribute_groups.attributes,customer_groups,routes,products,children.products',
          },
        )
        .then(response => {
    ...
    <div>
        <template v-if="loaded">
                ...
                <candy-tabs initial="categorydetails">
                    ...
                    <candy-tab :name="$t('product.CategoryDetails')" handle="category-details" :selected="true" dispatch="category-details">
                    ...
                    <candy-tab :name="$t('product.Associations')">
                        <candy-tabs nested="true">
                            <candy-tab :name="$t('product.Products')" :selected="true">
